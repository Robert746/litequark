    ...
    prevBlocks(0)
{
	...
	resize(949, 527);
    setWindowTitle(tr("LiteQuark Wallet") + " - " + tr("v0.8.3.20"));
    // Prevent resizing.
    setFixedSize(size());
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a LiteQuark address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About LiteQuark"), this);
    aboutAction->setStatusTip(tr("Show information about LiteQuark"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for LiteQuark"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your LiteQuark addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified LiteQuark addresses"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("LiteQuark client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to LiteQuark network", "", count));
}
...
{
    QString strTitle = tr("LiteQuark"); // default title
...
void BitcoinGUI::askFee(qint64 nFeeRequired, bool *payFee)
{
    QString strMessage = tr("This transaction is over the size limit. You can still send it for a fee of %1, "
        ...
        "Do you want to pay the fee?").arg(BitcoinUnits::formatWithUnit(BitcoinUnits::LTQ, nFeeRequired));
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            message(tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid LiteQuark address or malformed URI parameters."),
