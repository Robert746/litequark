    ...
    model(0)
{
    ...
    ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a LiteQuark address (e.g. 1XPezk48K6rrW9KLpLUPbSBPnWkV4nsb4)"));
#endif
...
void SendCoinsDialog::on_sendButton_clicked()
{
    ...
    foreach(const SendCoinsRecipient &rcp, recipients)
    {
        ...
        formatted.append(tr("<b>%1</b> to %2 (%3)").arg(BitcoinUnits::formatWithUnit(BitcoinUnits::LTQ, rcp.amount), Qt::escape(rcp.label), rcp.address));
#else
		formatted.append(tr("<b>%1</b> to %2 (%3)").arg(BitcoinUnits::formatWithUnit(BitcoinUnits::LTQ, rcp.amount), rcp.label.toHtmlEscaped(), rcp.address));
#endif
	}
    ...
    case WalletModel::AmountWithFeeExceedsBalance:
        QMessageBox::warning(this, tr("Send Coins"),
            ...
            arg(BitcoinUnits::formatWithUnit(BitcoinUnits::LTQ, sendstatus.fee)),
            QMessageBox::Ok, QMessageBox::Ok);
        break;
